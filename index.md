...
<div style="display: block; overflow: hidden; margin-bottom: 20px;">
  <img src="/assets/images/joker.jpg" style="width: 150px; height: 150px; float: left; margin-right: 20px; border-radius: 15px; border: 3px solid #bbdefb; object-fit: cover;">
